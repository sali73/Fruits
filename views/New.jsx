          ...
          <AppLayout>
              ...
              <div style={{ backgroundColor: '#f6f0c4 ', marginTop:'0px', padding:'50px 100px',borderLeft: '5px solid #d99ec9', textAlign: 'center' }}>
                <form style={{color:'#695787', fontSize:'27px',paddingLeft:'160px'}} action="/fruits" method="POST">
                    Name: <input style={{marginBottom:'20px', padding:'10px 150px',fontSize:'17px'}} type="text" name="name" /><br/>
                    Color: <input style={{marginBottom:'20px', padding:'10px 150px', fontSize:'17px'}}  type="text" name="color" /><br/>
                    Image: <input style={{marginBottom:'20px', padding:'10px 150px', fontSize:'17px'}}  type="text" name="img" /><br/>
                    Calories: <input style={{marginBottom:'20px', padding:'10px 150px', fontSize:'17px'}}  type="text" name="calories" /><br/>
